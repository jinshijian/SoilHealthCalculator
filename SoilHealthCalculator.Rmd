...
ggsave("Manuscript/Datainbrief/Figures/Figure1.jpg", width = 8, height = 7, dpi = 300, units = "in")
...
```{r DIB figure 3, fig.height = 6, fig.width = 10}
tiff("Manuscript/Datainbrief/Figures/Figure3.tiff", width = 9, height = 6, pointsize = 1/300, units = 'in', res = 300)
par( mar=c(2, 0.2, 0.2, 0.2)
     , mai=c(0.15, 0.6, 0.1, 0.1)  # by inches, inner margin
     , omi = c(1.6, 0.3, 0.3, 0.1)  # by inches, outer margin 
     , mgp = c(0, 0.3, 0) # set distance of axis
...
for (i in 2) {
  ...
  axis (side = 3, at = c(1, 3.5, 7, 10.5, 16), cex=1, labels = c("all", paste("Climate (p=", P_climate, ")", sep = "")
                                                                      , paste("Texture (p=", P_texture, ")", sep = "")
                                                                      , paste("Cover crops (p=", P_CoverCrop, ")", sep = "")
                                                                      , paste("Cash crops (p=", P_GrainCrop, ")", sep = "")  ))
  
  # add x labels
  mtext(side = 2, text = paste("Yield", " (log RR)", sep=""), line = -0.25, cex=1.25, outer = T)
}
dev.off()
```
